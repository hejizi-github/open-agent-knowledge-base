---
id: project-context-52b231aab8a1
type: offline-source-pack
captured_at: 2026-04-28T13:04:53Z
project: open-agent-knowledge-base
git_head: 6a81550
source_fingerprint: 52b231aab8a1
---
...
- .gitignore
- README.md
- articles/drafts/agent-memory-misconceptions-sec0.md
- articles/drafts/agent-memory-misconceptions-sec1.md
- articles/drafts/agent-memory-misconceptions-sec2.md
- articles/drafts/agent-memory-misconceptions-sec3.md
- articles/drafts/agent-memory-misconceptions-sec4.md
- articles/drafts/agent-memory-misconceptions-sec5.md
- articles/drafts/agent-memory-misconceptions-sec6.md
- articles/drafts/crewai-architecture-tension.md
...
- articles/index.md
- articles/published/crewai-architecture-tension.md
...
- image-prompts/agent-memory-misconceptions.md
- image-prompts/crewai-architecture-tension.md
